...
(dark toolbar, cream paper pages) and the same parsing rules. Supports
the full EPP 0.1–0.3 grammar, including v0.3's callout boxes, highlighted
text, and page-level styling (background tint, notebook-style lined
pages, and 90°/180°/270° page rotation).
...
- `LICENSE` — usage terms (free to use; see file for details)
