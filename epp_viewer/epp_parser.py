...
epp-core.js (the EPP Viewer browser extension). It turns raw .epp source
text into a structured document: a list of pages, each containing an
ordered list of "blocks" (heading, text, bullet, code, quote, table,
label, space, line), plus document-level title/header/footer/meta.

The renderer (epp_render.py) consumes this structure to draw pages.
"""
...
TEXT_TYPES = ("heading", "text", "bullet", "code")
